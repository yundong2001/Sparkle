...
namespace SPK
{
    namespace Vulkan
    {
        ImageView::ImageView(Image *image, VkImageViewType viewType, VkFormat format, uint32_t baseMipLevel,
                             uint32_t baseArrayLevel, uint32_t nMipLevels, uint32_t nArrayLayers):
        ...
        ImageView::ImageView(Device *device, VkImage image, VkImageViewType viewType, VkFormat format,
                             uint32_t baseMipLevel, uint32_t baseArrayLevel, uint32_t nMipLevels, uint32_t nArrayLayers):
        ...
        void ImageView::Setup(VkImage image, VkImageViewType viewType, uint32_t baseMipLevel, uint32_t baseArrayLevel,
